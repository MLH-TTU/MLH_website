        ...
        <div className="max-w-7xl mx-auto px-8">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-3 gap-8">
              {/* Event Card 1 - Major League */}
              <a 
                href="/major-league"
                className="group bg-white dark:bg-gray-800 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden hover:-translate-y-2 block cursor-pointer"
              >
                <div className="relative h-64 bg-gradient-to-br from-red-600 via-red-500 to-yellow-500 flex items-center justify-center p-8">
                  {/* Shield-like design inspired by MLH badge */}
                  <div className="relative w-full h-full flex flex-col items-center justify-center gap-4">
                    <div className="absolute inset-0 bg-gradient-to-b from-blue-900/10 to-transparent rounded-t-3xl"></div>
                    
                    {/* MLH Logo - Bigger */}
                    <div className="relative z-10 transform group-hover:scale-110 transition-transform duration-300">
                      <img 
                        src="/major-league-logo.png" 
                    ...
                    {/* Title Card */}
                    <div className="relative z-10 bg-white/95 backdrop-blur-sm rounded-2xl px-10 py-4 shadow-2xl transform group-hover:scale-105 transition-transform duration-300">
                    ...
                    <div className="relative z-10 flex justify-center gap-3">
                      <div className="w-2.5 h-2.5 bg-yellow-300 rounded-full shadow-lg"></div>
                      <div className="w-2.5 h-2.5 bg-yellow-300 rounded-full shadow-lg"></div>
                      <div className="w-2.5 h-2.5 bg-yellow-300 rounded-full shadow-lg"></div>
                    </div>
                  </div>
              ...
              {/* Event Card 2 - III */}
              <div className="group bg-white dark:bg-gray-800 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden hover:-translate-y-2">
                <div className="relative h-64 bg-gradient-to-br from-blue-600 via-blue-500 to-cyan-400 flex items-center justify-center p-8">
                  <div className="relative w-full h-full flex items-center justify-center">
                    <div className="absolute inset-0 bg-gradient-to-b from-indigo-900/20 to-transparent rounded-t-3xl"></div>
                    <div className="relative z-10 text-center">
                      <div className="bg-white/95 backdrop-blur-sm rounded-2xl px-12 py-8 shadow-2xl transform group-hover:scale-105 transition-transform duration-300">
                        <h3 className="text-6xl font-black text-gray-900 tracking-wider">
                          III
                        </h3>
                      </div>
                      {/* Decorative elements */}
                      <div className="flex justify-center gap-3 mt-4">
                        <div className="w-3 h-3 bg-cyan-300 rounded-full shadow-lg"></div>
                        <div className="w-3 h-3 bg-cyan-300 rounded-full shadow-lg"></div>
                        <div className="w-3 h-3 bg-cyan-300 rounded-full shadow-lg"></div>
                      </div>
                    </div>
              ...
              {/* Event Card 3 - SSS */}
              <div className="group bg-white dark:bg-gray-800 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden hover:-translate-y-2">
                <div className="relative h-64 bg-gradient-to-br from-yellow-500 via-yellow-400 to-orange-400 flex items-center justify-center p-8">
                  <div className="relative w-full h-full flex items-center justify-center">
                    <div className="absolute inset-0 bg-gradient-to-b from-orange-900/20 to-transparent rounded-t-3xl"></div>
                    <div className="relative z-10 text-center">
                      <div className="bg-white/95 backdrop-blur-sm rounded-2xl px-12 py-8 shadow-2xl transform group-hover:scale-105 transition-transform duration-300">
                        <h3 className="text-6xl font-black text-gray-900 tracking-wider">
                          SSS
                      ...
                      {/* Decorative elements */}
                      <div className="flex justify-center gap-3 mt-4">
                        <div className="w-3 h-3 bg-orange-300 rounded-full shadow-lg"></div>
                        <div className="w-3 h-3 bg-orange-300 rounded-full shadow-lg"></div>
                        <div className="w-3 h-3 bg-orange-300 rounded-full shadow-lg"></div>
                      </div>
                    </div>
        ...
        <div className="max-w-7xl mx-auto px-8">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 mb-12">
            ...
            <div className="flex items-center gap-3">
              <a href="https://discord.gg/6nBEZhegGK" target="_blank" rel="noopener noreferrer" className="group relative p-3 bg-white/5 hover:bg-white/10 rounded-xl transition-all duration-300 hover:scale-110">
              ...
              <a href="https://www.instagram.com/mlhttu?igsh=MWJ6ZzdnM3VzdWQ1aQ==" target="_blank" rel="noopener noreferrer" className="group relative p-3 bg-white/5 hover:bg-white/10 rounded-xl transition-all duration-300 hover:scale-110">
                <svg className="w-5 h-5 text-gray-300 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://linktr.ee/MLH_TTU" target="_blank" rel="noopener noreferrer" className="group relative p-3 bg-white/5 hover:bg-white/10 rounded-xl transition-all duration-300 hover:scale-110">
                <svg className="w-5 h-5 text-gray-300 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                </svg>
              </a>
              <a href="mailto:ttumajorleaguehacking@gmail.com" className="group relative p-3 bg-white/5 hover:bg-white/10 rounded-xl transition-all duration-300 hover:scale-110">
                <svg className="w-5 h-5 text-gray-300 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
