        ...
        <div className={`mx-auto transition-all duration-300 ${
          ...
          <div 
            className={`transition-all duration-300 ${
              isScrolled
                ? 'mx-auto w-fit rounded-full px-8 py-3 bg-white/10 dark:bg-gray-800/30 backdrop-blur-[20px] backdrop-saturate-[180%] border border-white/20 dark:border-gray-700/30 shadow-[0_8px_32px_rgba(0,0,0,0.1),inset_0_1px_0_rgba(255,255,255,0.3)]'
          ...
          {mobileMenuOpen && (
            <div className="md:hidden mt-2 bg-white dark:bg-gray-900 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
              <div className="px-4 pt-2 pb-3 space-y-3">
                ...
                {user && user.hasCompletedOnboarding ? (
                  <>
                    ...
                    <button 
                      ...
                      className="block w-full bg-red-600 hover:bg-red-700 text-white px-4 py-3 rounded-full text-base font-medium transition-colors duration-100 text-center min-h-[44px]"
                    >
                      Profile
                    </button>
                  </>
                  ...
                  <>
                    <button 
                      ...
                      className="block w-full text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-50 dark:hover:bg-gray-800 px-4 py-3 rounded-md text-base font-medium transition-colors duration-100 min-h-[44px]"
                    >
                      Login
                    </button>
                    <button 
                ...
                <button 
                  onClick={() => setMobileMenuOpen(false)}
                  className="block w-full bg-gray-900 hover:bg-gray-800 text-white px-4 py-3 rounded-full text-base font-medium transition-colors duration-100 text-center min-h-[44px]"
                >
                  Join Discord
                </button>
              </div>
      ...
      <section id="events" className="py-20 bg-white dark:bg-gray-900 transition-colors duration-200">
        <div className="max-w-7xl mx-auto px-8">
          ...
          <div className="mt-20 grid md:grid-cols-3 gap-8">
            <div className="text-center p-6 bg-gray-50 dark:bg-gray-800 rounded-2xl transition-colors duration-200">
              <div className="w-16 h-16 bg-red-100 dark:bg-red-900 rounded-full flex items-center justify-center mx-auto mb-4 transition-colors duration-200">
                <svg className="w-8 h-8 text-red-600 dark:text-red-400" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
                </svg>
              </div>
              <h4 className="text-xl font-bold text-gray-900 dark:text-white mb-2 transition-colors duration-200">Hackathons</h4>
              <p className="text-gray-600 dark:text-gray-300 transition-colors duration-200">24-48 hour coding competitions where you build amazing projects</p>
            </div>
            ...
            <div className="text-center p-6 bg-gray-50 dark:bg-gray-800 rounded-2xl transition-colors duration-200">
              ...
              <h4 className="text-xl font-bold text-gray-900 dark:text-white mb-2 transition-colors duration-200">Workshops</h4>
              <p className="text-gray-600 dark:text-gray-300 transition-colors duration-200">Hands-on learning sessions covering the latest technologies</p>
            </div>

            <div className="text-center p-6 bg-gray-50 dark:bg-gray-800 rounded-2xl transition-colors duration-200">
              <div className="w-16 h-16 bg-yellow-100 dark:bg-yellow-900 rounded-full flex items-center justify-center mx-auto mb-4 transition-colors duration-200">
              ...
              <h4 className="text-xl font-bold text-gray-900 dark:text-white mb-2 transition-colors duration-200">Networking</h4>
              <p className="text-gray-600 dark:text-gray-300 transition-colors duration-200">Connect with industry professionals and fellow students</p>
            </div>
          </div>
        </div>
      </section>
